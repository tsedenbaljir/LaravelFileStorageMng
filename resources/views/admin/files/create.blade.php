        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('folder_id', trans('Хавтас сонгох').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('filename', trans('Файл оруулах').'*', ['class' => 'control-label']) !!}
                    {!! Form::file('filename[]', [
                        'multiple',
                    ...
                    <div class="photo-block">
                        <div class="progress-bar form-group">Ачааллаж дуустал түр хүлээнэ үү ! ...&nbsp;</div>
        ...
        $(function () {
            ...
            $('input#my_id').change(function () {
                ...
                if (totalCount > 5 && roleId == 2) {
                    alert("5 аас илүү файл зэрэг оруулах эрэхгүй байна." +
                            "Хүсэлт гаргаж давуу эрх эдлээрэй.");
